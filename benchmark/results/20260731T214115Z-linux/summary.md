...
Machine: `linux`  Suite requested: `quick`  Prompt SHA-256: `57671a04b87ac7c0a596dca0a403b2d774d632d6ca92041c1b3963f1d916f503`
...
|---|---|---|---|---|---|---:|---:|---:|
| `qwen3:8b` | `qwen3:8b` | tier1 | FAIL | FAIL | manual review required | 5.5% | 62.8 | 15.6m |
| `llama3.1:8b` | `llama3.1:8b` | tier1 | FAIL | FAIL | manual review required | 8.2% | 64.5 | 15.2m |
| `granite3.3:8b` | `granite3.3:8b` | tier1 | FAIL | FAIL | manual review required | 8.2% | 60.6 | 17.6m |
...
- `malformed_row`: 15 response/attempt occurrence(s)
- `structural_incomplete`: 13 response/attempt occurrence(s)
- `unknown_vocabulary`: 13 response/attempt occurrence(s)
