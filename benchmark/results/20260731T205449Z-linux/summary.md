...
|---|---|---|---|---|---|---:|---:|---:|
| `qwen3:8b` | `qwen3:8b` | tier1 | FAIL | FAIL | manual review required | 5.5% | 59.7 | 15.5m |
...
- `malformed_row`: 5 response/attempt occurrence(s)
- `structural_incomplete`: 5 response/attempt occurrence(s)
