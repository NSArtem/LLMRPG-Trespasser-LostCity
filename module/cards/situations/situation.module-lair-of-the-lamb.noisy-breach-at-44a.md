...
- **The Lamb** (`actor.module-lair-of-the-lamb.the-lamb-25359288`) takes part: Approaches separately and waits underwater in the cistern.
...
- **The Lamb** (`actor.module-lair-of-the-lamb.the-lamb-25359288`) — Arrive in 5+1d4 minutes and wait on the cistern bottom near the underwater tunnel mouth.
...
- `actor-state` → **The Lamb** (`actor.module-lair-of-the-lamb.the-lamb-25359288`) — After arriving, the Lamb waits on the bottom near the underwater tunnel mouth. (condition: The Lamb is alive when its arrival delay resolves.)
