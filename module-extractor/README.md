...
Module Extractor is the adventure-ingestion component of LLM Loremaster. It
turns an adventure PDF into a source-cited module for an LLM game master.
ChatGPT performs bounded extraction, Codex performs final semantic review, and
deterministic local code remains authoritative for validation and release
assembly.
